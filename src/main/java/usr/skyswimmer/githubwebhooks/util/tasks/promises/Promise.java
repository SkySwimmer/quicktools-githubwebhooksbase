package usr.skyswimmer.githubwebhooks.util.tasks.promises;

import java.lang.reflect.InvocationTargetException;

import usr.skyswimmer.githubwebhooks.util.events.Event;
import usr.skyswimmer.githubwebhooks.util.tasks.TaskCompletedEvent;
import usr.skyswimmer.githubwebhooks.util.tasks.TaskErroredEvent;
